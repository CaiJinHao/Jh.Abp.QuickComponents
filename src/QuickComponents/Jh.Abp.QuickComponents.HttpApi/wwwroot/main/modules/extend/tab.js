					...
					f.find("li").each(function () {
						...
						k.off("click").on("click", function () {
							...
							switch(a) {
                                ...
                                case "lockcms":
                                    i.lockPage();//点击就锁屏
                                    localStorage.setItem("lockcms", true);//上锁
									break;
								// 清缓存	
								case "clearcache":
									// 缓存
